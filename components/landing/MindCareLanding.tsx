        ...
        <section className="relative pt-32 sm:pt-48 pb-16 sm:pb-24 px-4 sm:px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5f559a] via-[#bdb2ff] to-[#5f559a] bg-size-200 animate-gradient">Understood.</span>
            </motion.h1>
            ...
            >
              MindCare uses context-aware intelligence to analyze your thoughts and behavior patterns, providing personalized insights that evolve with you.
            </motion.p>
              ...
              <div className="w-full lg:w-1/2">
                ...
                <div className="space-y-6 text-center lg:text-left">
                  <p className="text-lg sm:text-xl text-[#484550] leading-relaxed">
                    MindCare is an AI-powered sanctuary designed for the modern mind. We believe that mental health is a journey, not a destination.
                  </p>
                  <p className="text-lg sm:text-xl text-[#484550] leading-relaxed">
                    By leveraging context-aware intelligence and long-term behavioral analysis, we bridge the gap between simple tracking and true self-understanding.
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-10">
                    <div className="p-6 bg-[#f3f3f3] rounded-[1.5rem] sm:rounded-[2rem]">
                      <h4 className="font-bold text-[#1b0c53] mb-2">Contextual</h4>
                      <p className="text-sm text-[#5f559a]">AI that remembers your journey.</p>
                    </div>
                    <div className="p-6 bg-[#f3f3f3] rounded-[1.5rem] sm:rounded-[2rem]">
                      <h4 className="font-bold text-[#1b0c53] mb-2">Private</h4>
                      <p className="text-sm text-[#5f559a]">Your data is your sanctuary.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-20">
               <h2 className="font-['Outfit'] text-4xl sm:text-5xl md:text-6xl font-black tracking-tighter text-[#1b0c53] leading-tight mb-4 sm:mb-6">
                 Old Tracking vs. New Intelligence
               </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10">
              ...
              <div className="p-8 sm:p-16 bg-white/40 backdrop-blur-xl border border-white/60 rounded-[2rem] sm:rounded-[3rem] shadow-xl">
                 ...
                 <h3 className="text-2xl sm:text-3xl font-black text-[#1b0c53] mb-6 sm:mb-8 tracking-tight">The Legacy Problem</h3>
                 <ul className="space-y-4 sm:space-y-6">
                   {[
                     "Users track data but don’t get real insights",
                     "Generic suggestions that feel robotic",
                     "No long-term understanding of patterns",
              ...
              <div className="p-8 sm:p-16 bg-[#1b0c53] rounded-[2rem] sm:rounded-[3rem] shadow-2xl text-white relative overflow-hidden group">
                 ...
                 <ul className="space-y-4 sm:space-y-6 relative z-10">
                   {[
                     "AI that remembers and learns past behavior",
                     "Context-aware insights using reasoning",
